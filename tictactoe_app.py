...
if not st.session_state["spielgestartet"]:
    titelbild = Image.open("Bilder/Titelbild.jpg").resize((420, 620))
    st.image(titelbild)
...
# Bilder laden
img_X = Image.open("Bilder/Spieler_01.jpg").resize((80, 80))
img_O = Image.open("Bilder/Spieler_02.jpg").resize((80, 80))
img_blank = Image.open("Bilder/Button.jpg").resize((80, 80))
